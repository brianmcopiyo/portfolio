...
<head>
  ...
  <title>Vision Nexus|Error</title>
  <!-- Google tag (gtag.js) -->
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                <li><a href="{{ route('home') }}#home-section" class="nav-link">Home</a></li>
                <li>
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    <li><a href="{{ route('home') }}#about-section">Specialties</a></li>
                    <li><a href="{{ route('home') }}#team-section">Our Team</a></li>
                  </ul>
                </li>
                <li><a href="{{ route('home') }}#blog-section" class="nav-link">Blog</a></li>
            ...
            <div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
              ...
              <div class="row justify-content-center mb-4">
                <div class="col-md-10 text-center">
                  ...
                  <p class="lead mb-5">Sorry! We can't find the page you are looking for.</p>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-3 ml-auto">
                  ...
                  <ul class="list-unstyled">
                    <li><a href="{{ route('home') }}#home-section">Home</a></li>
                    <li><a href="{{ route('home') }}#about-section">About Us</a></li>
                    <li><a href="{{ route('home') }}#services-section">Services</a></li>
                    <li><a href="{{ route('home') }}#testimonial-section">Testimonials</a></li>
