  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="{{ route('home') }}" class="mb-0">Vision Nexus<span class="text-primary">.</span> </a></h1>
          </div>
            ...
            <div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
              ...
              <div class="row justify-content-center mb-4">
                <div class="col-md-10 text-center">
                  ...
                  <p class="lead mb-5">VisionNexus: Crafting seamless digital experiences across web, systems, mobile platforms, and database design.</p>
                  <div><a href="#contact-section" class="btn btn-primary btn-md">Hire Us</a></div>
                </div>
              </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col" data-aos="fade-in" data-aos-delay="0">
              <img src="images/php.png" alt="Image" class="img-fluid small">
            </div>
            <div class="col" data-aos="fade-in" data-aos-delay="100">
              <img src="images/laravel.png" alt="Image" class="img-fluid small">
            </div>
            <div class="col" data-aos="fade-in" data-aos-delay="200">
              <img src="images/js.png" alt="Image" class="img-fluid small">
            </div>
            <div class="col" data-aos="fade-in" data-aos-delay="300">
              <img src="images/flutter.png" alt="Image" class="img-fluid small">
            </div>
            <div class="col" data-aos="fade-in" data-aos-delay="400">
              <img src="images/figma.png" alt="Image" class="img-fluid small">
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="row">
            <div class="col-md-6 col-lg-4 mb-lg-0 mb-4">
              <div class="box-with-humber bg-white p-5">
                ...
                <p class="mb-4">Our strategy at VisionNexus is to meticulously craft innovative brand strategies that align with our clients' goals, ensuring their brands stand out and thrive in the digital realm.</p>
            ...
            <div class="col-md-6 col-lg-4 mb-lg-0 mb-4" data-jarallax-element="-50">
              <div class="box-with-humber bg-white p-5">
                ...
                <p class="mb-4">We specializes in crafting compelling visual identities that authentically represent brands, leaving a lasting impression across all digital and physical touchpoints.</p>
                <ul class="list-unstyled ul-check primary">
                  <li>Web Design</li>
                  <li>Branding</li>
            ...
            <div class="col-md-6 col-lg-4 mb-lg-0 mb-4" data-jarallax-element="20">
              <div class="box-with-humber bg-white p-5">
                ...
                <p class="mb-4">We excel in creating visually stunning and user-friendly websites that perfectly align with our clients' brands and goals, ensuring a seamless online experience.</p>
                <ul class="list-unstyled ul-check primary">
                  <li>Social Media</li>
        ...
        <div class="container">
          <div class="row align-items-center justify-content-around">
            <div class="col-lg-5" data-jarallax-element="-50">
              <h2 class="text-primary">Web Design</h2>
              <p class="mb-4">we excel in creating visually stunning and user-friendly websites that perfectly align with our clients' brands and goals, ensuring a seamless online experience for their audience.</p>
              <ul class="list-unstyled ul-check primary">
                <li>Social Media</li>
                <li>Paid Campaigns</li>
                <li>Marketing &amp; SEO</li>
        ...
        <div class="container">
          <div class="row mb-5 justify-content-center">
            <div class="col-md-8 text-center">
              ...
              <p class="lead">Delivering excellence in web design, mobile app development, system integration, and database design, our portfolio reflects our dedication to innovative digital solutions that surpass client expectations</p>
            </div>
          </div>
        </div>
            ...
            <div class="col-md-12 mb-5">
              ...
              <form method="POST" action="{{ route('create') }}" class="p-5 bg-white">
                ...
                <div class="row form-group">
                  ...
                  <div class="col-md-12">
                    <label class="text-black" for="email">Email or Phone Number</label>
                ...
                <div class="row form-group">
                  <div class="col-md-12">
                    ...
                    <textarea name="message" id="message" cols="30" rows="7" class="form-control" placeholder="Give us your problem statement here."></textarea>
                  </div>
                </div>
    ...
    <script>
      var typed = new Typed('.typed-words', {
        strings: ["Websites", "Web Apps","Mobile Apps", "Databases"],
        typeSpeed: 80,
        backSpeed: 80,
        backDelay: 4000,
        startDelay: 1000,
